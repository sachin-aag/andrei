...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    checked={checked}
    className={cn(
      "relative flex cursor-pointer select-none items-start gap-2 rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none",
      "focus:bg-[var(--secondary)] focus:text-[var(--foreground)]",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-[10px] font-semibold uppercase tracking-wide text-[var(--muted-foreground)]",
      className
    )}
    {...props}
  />
