...
function buildWorkerPrompt(input: SheetExtractJobInput): string {
  ...
  return [
    ...
    locator || null,
    "Create this sheet with manage_worksheet add_sheet if it does not already exist. Use the assigned name. Do not rename or delete other sheets.",
    ...
    "Then one write_column to this sheet only. Always pass sheetId (the id from add_sheet, or the existing id). Do not write other sheets. Do not invent cells.",
