...
export const ELR_TOC_HEADINGS: readonly TocHeadingSpec[] = [
  ...
  heading("3.6 ALARM TRENDS", "Heading2"),
  heading("3.6.1 ALARM TREND SUMMARY", "Heading3"),
  heading("3.7 MONITORING", "Heading2"),
  heading("3.8 CALIBRATION OF ASSOCIATED INSTRUMENTS", "Heading2"),
  heading("3.9 PREVENTIVE MAINTENANCE", "Heading2"),
  heading("3.10 BREAKDOWNS AND TRENDS", "Heading2"),
  heading("3.10.1 BREAKDOWN TREND SUMMARY", "Heading3"),
  heading("3.11 QMS RECORDS SINCE LAST PERIODIC RE-QUALIFICATION", "Heading2"),
