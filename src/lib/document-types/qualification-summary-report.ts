...
You never write to the document directly — every change is a PROPOSAL the engineer accepts or rejects.`,
    ...
    sectionIntentPatterns: [
      ["qsr_objective", [/\bobjective\b/i]],
      ["qsr_scope", [/\bscope\b/i]],
      ["qsr_references", [/\breferences?\b/i]],
      ["qsr_acronyms", [/\bacronyms?\b/i, /\babbreviations?\b/i]],
      ["qsr_overview", [/\boverview\b/i]],
      ["qsr_background", [/\bbackground\b/i]],
      ...
      ["qsr_rtm_process", [/\bprocess requirements?\b/i, /\btraceability\b/i, /\brtm\b/i]],
      ["qsr_rtm_control", [/\bcontrol philosophy\b/i]],
      ["qsr_rtm_gmp", [/\bgmp requirements?\b/i]],
      ["qsr_rtm_safety", [/\bsafety requirements?\b/i]],
      ["qsr_rtm_csv", [/\bcsv\b/i, /\bcomputer system validation\b/i]],
      ["qsr_rtm_maintenance", [/\bmaintenance\b/i, /\bcleaning requirements?\b/i]],
      ["qsr_volumetric_details", [/\bvolumetric\b/i, /\bvolumes?\b/i]],
      ["qsr_operating_range", [/\boperating range\b/i, /\bpressure\b/i, /\btemperature\b/i]],
      ["qsr_other_details", [/\bother details\b/i, /\bagitator\b/i]],
