...
export default async function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex flex-1 bg-[var(--brand-600)] p-16 flex-col justify-between relative overflow-hidden">
        <div
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-white/70">Drug Product · Hinjawadi</div>
          </div>
        </div>
