...
- `document-review.ts` — `selectReviewPages` fair-shares the 300-page cap. `start_document_review` returns `truncated` / `skippedDocuments`. Rehydrate `coverageKey` is selected documents' full page counts.
