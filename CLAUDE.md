...
M.J. Biopharm quality-document tool — a Next.js 16 app replacing DOCX-over-email
workflows. Two `documentType`s: **investigation reports** (DMAIC, SOP/DP/QA/008)
and **design verification**. Shared product surface: in-browser editor with
auto-save, AI traffic-light evaluation (Gemini via AI Gateway or Vertex),
manager review, attachment evidence (PDF/DOCX ingest + chat retrieval), and
DOCX export.
