...
same Flash-Lite intent call sets `sectionQueue` (timeout/stub fall back to
the remaining-section regex) because the engineer asked to fill several empty
`draftOrder` sections. Each turn drafts
