...
The same engine ships as three customer packs: **demo** (Andrei branding, investigation reports plus design verification plus a free-form Document), **mj** (M.J. Biopharm SOP/DP/QA/008 overlay), and **convergent** (Convergent Dental branding, design verification plus a free-form Document).
...
- **Document types** — investigation reports (DMAIC), design verification, and (demo and Convergent packs) a free-form Document. Chat, evaluation, suggestions, and editors all go through `src/lib/document-types/`.
...
| `generic_document` | document | one continuous `body` section (demo and Convergent packs; no criteria) |
...
| `convergent` | `ANDREI_CUSTOMER=convergent` | Convergent Dental branding, design verification plus Document (9-section Solea DV template) |
