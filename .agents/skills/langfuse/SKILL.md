...
- migrating a Langfuse project to v4 (ingestion, evaluators, deprecated APIs, exports): references/v4-project-migration.md
...
export LANGFUSE_HOST={LANGFUSE_HOST} # example for EU cloud. For US cloud it's us.cloud.langfuse.com, and can also be a self-hosted URL. The server must always be specified in order to access Langfuse.
```
